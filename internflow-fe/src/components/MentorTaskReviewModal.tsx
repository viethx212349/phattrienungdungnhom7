    ...
    <div className="overlay">
      ...
      <div className="modal">
        ...
        <div className="modal-header">
          <h1 className="modal-title">Nghiệm thu công việc</h1>
        ...
        <div className="modal-body">
          ...
          <div className="task-card">
            ...
            <div>
              <p className="label">TÊN CÔNG VIỆC</p>
            ...
            <div className="info-row">
              ...
              <div>
                <p className="label">NGƯỜI THỰC HIỆN</p>
              ...
              <div>
                <p className="label">NGÀY NỘP</p>

                <div className="info-item">
                  <span className="icon">📅</span>

                  <span className="info-text">{task.submittedAt}</span>
                </div>
              </div>
            </div>
            ...
            <div className="attachment-section">
              <p className="label">TÀI LIỆU ĐÍNH KÈM</p>
              ...
              >
                ...
                <span>Link báo cáo đính kèm</span>
              </a>
            </div>
          </div>
