...
3. Mở phần mềm `InternFlow` từ màn hình Desktop hoặc Start Menu.
...
npm run dev
```
*(Backend sẽ chạy ở địa chỉ http://localhost:4000)*
...
npm run dev
```
*(Giao diện Desktop App sẽ khởi động. Vite chạy ngầm proxy API sang cổng 4000)*
